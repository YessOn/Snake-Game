	...
	def move(self):
		...
		for i, cube in enumerate(self.body):
			...
			if pos in self.turns:
				...
				if cube.dirnx == -1 and cube.pos[0] <= 0: cube.pos = (cols - 1, cube.pos[1])
				elif cube.dirnx == 1 and cube.pos[0] >= cols - 1: cube.pos = (0, cube.pos[1])
				elif cube.dirny == 1 and cube.pos[1] >= rows - 1: cube.pos = (cube.pos[0], 0)
				elif cube.dirny == -1 and cube.pos[1] <= 0: cube.pos = (cube.pos[0], rows - 1)
